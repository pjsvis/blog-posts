...
This is the Palimpsest Problem in the wild. The myth wasn't deliberately planted — it scraped away the superscript bar through sheer repetition and the gravitational pull of narrative shape. One character. Dramatic. Legible to non-engineers. The reality doesn't compress well and doesn't survive a first retelling. The wrong version is now the canonical version in every "fun fact" list and thought-leadership essay that needed a quick hook. We use the myth as our hook precisely because it's wrong: open with the most expensive hyphen in history, then replace it with the superscript bar. The debunk is the proof of concept. This isn't a gotcha — it's a live demonstration of the verification gate in action.
